...
//Constructorul implicit initializeaza membrul tip_magazin cu nullptr(adresa nula)
Magazin_virtual::Magazin_virtual()
{
    tip_magazin = 0;
}
//Constructorul cu parametri primeste un sir de caractere (TM) si opiaza continutul din TM în memoria alocat?
Magazin_virtual::Magazin_virtual(char* TM)
{
    tip_magazin = new char[strlen(TM) + 1];
    strcpy(tip_magazin, TM);
}
//Destructorul elibereaza memoria alocata dinamic pentru membrii clasei Magazin Virtual 
Magazin_virtual::~Magazin_virtual()
{
    delete tip_magazin;
}
...
//Destructorul elibereaza memoria alocata dinamic pentru membrii clasei MV_ProdElec
...
//Constructorul pentru o serie de parametri pentru a initializa obiectul MV_Laptop
...
//Destructorul elibereaza memoria alocata dinamic pentru membrii clasei MV_Laptop
MV_Laptop::~MV_Laptop()
{
    delete so;
    delete gpu;
...
//Metoda verifica stocul produsului
...
//Metoda actualizeaza stocul produsului
...
//Destructorul eliberează memoria alocată dinamic pentru variabilele
...
//Metoda afiseaza mesajul in functie de disponibilitate
...
//Destructorul eliberează memoria alocată dinamic pentru variabila : nume_firma
MV_TV ::~MV_TV()
{
    delete nume_firma;
}
...
//Destructorul eliberează memoria alocată dinamic pentru variabilele : nume_firma si so
MV_Mobile ::~MV_Mobile()
{
    delete nume_firma;
    delete so;
...
//Destructorul eliberează memoria alocată dinamic pentru variabilele : tip_produs, nume_firma, si specificatii
...
int main()
{
    ...
    //administrator
    Administrator admin1((char*)"Bucur Dragos", (char*)"Bdragos@gmail.com", (int)1);
    admin1.afisare();
    ...
    Administrator admin3((char*)"Mihai George", (char*)"Mihaigeorge@gmail.com", (int)2);
    admin3.afisare();
    ...
    soffice2->afisare();
    soffice2->actualizare_pret(3532.53);
    ...
    mobile2->afisare();
    mobile2->actualizare_pret(674.87);
    ...
    comp2->afisare();
    comp2->actualizare_pret(2567.99);
    comp2->afisare_pret();
    comp2->act_nrcom(34);
    comp2->get_nrcom();
    ...
    cout << "\n\n\n_______________________________________________________________________\n" << endl;
    cout << "Al treilea set de date: " << endl;
    cout << "_______________________________________________________________________\n" << endl;

    Administrator admin5((char*)"Andreea Ioana", (char*)"Andreeai@gmail.com", (int)2);
    admin5.afisare();
    ...
    mobile3->afisare();
    mobile3->actualizare_pret(7564.4);
